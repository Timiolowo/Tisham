...
export function TeacherLearning({ onBack, onNavigate }: TeacherLearningProps) {
  ...
  const extractContentFromText = (text: string, topic: string): AILearningContent => {
    return {
      ...
      mainContent: `This topic covers important concepts related to ${topic}. The content is being generated by Tishami to provide you with comprehensive learning materials.`,
      keyPoints: [
